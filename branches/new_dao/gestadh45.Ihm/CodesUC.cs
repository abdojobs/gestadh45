...
namespace gestadh45.Ihm
{
	public class CodesUC
	{
		...
		public const string ConsultationParamsApplication = "ConsultationParamsApplication";
		...
		public const string FormulaireParamsApplication = "FormulaireParamsApplication";
