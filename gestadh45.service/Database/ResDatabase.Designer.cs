...
namespace gestadh45.service.Database {
    ...
    public class ResDatabase {
        ...
        /// <summary>
        ///   Recherche une chaîne localisée semblable à CREATE VIEW IF NOT EXISTS V_AdresseComplete AS
        ///
        ///SELECT
        ///adr.ID,
        ///adr.Libelle,
        ...
        ///sai.Anne [le reste de la chaîne a été tronqué]&quot;;.
        /// </summary>
        public static string SQL_CreateViews {
            get {
                return ResourceManager.GetString("SQL_CreateViews", resourceCulture);
            }
        }
